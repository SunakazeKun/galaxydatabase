...
PropertyInfo("GeneralPos", "setup", use_need=True, use_values=True)
PropertyInfo("Camera", "setup", use_need=True, use_values=True)
PropertyInfo("DemoCast", "setup", use_need=True, use_values=True, default_description="Can take part in a cutscene.")
