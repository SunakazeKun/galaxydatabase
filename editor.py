...
class DatabaseEditor(QMainWindow):
    ...
    def register_object_events(self):
        ...
        self.checkObjSMG1.stateChanged.connect(lambda s: self.toggle_obj_mask("Games", 1, s))
        self.checkObjSMG2.stateChanged.connect(lambda s: self.toggle_obj_mask("Games", 2, s))
        ...
        self.checkObjIsUnused.stateChanged.connect(lambda s: self.set_obj_attr("IsUnused", s))
        self.checkObjIsLeftover.stateChanged.connect(lambda s: self.set_obj_attr("IsLeftover", s))
    ...
    def register_class_events(self):
        ...
        self.checkClassSMG1.stateChanged.connect(lambda s: self.toggle_class_mask("Games", 1, s))
        self.checkClassSMG2.stateChanged.connect(lambda s: self.toggle_class_mask("Games", 2, s))
    ...
    def register_property_events(self):
        ...
        self.checkPropertySMG1.stateChanged.connect(lambda s: self.toggle_property_mask("Games", 1, s))
        self.checkPropertySMG2.stateChanged.connect(lambda s: self.toggle_property_mask("Games", 2, s))
        self.checkPropertyNeeded.stateChanged.connect(lambda s: self.set_property_attr("Needed", s))
